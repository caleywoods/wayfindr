...
object WayfindrModClient : ClientModInitializer {
    ...
    override fun onInitializeClient() {
        ...
        // Register navigation renderer using the 1.21.6 HUD rendering approach
        ClientTickEvents.END_CLIENT_TICK.register { client ->
            // The navigation renderer will be called directly during HUD rendering
            val mcClient = MinecraftClient.getInstance()
            if (mcClient.player != null && mcClient.currentScreen == null && !mcClient.isPaused && WaypointManager.getNavigationTarget() != null) {
                // We'll render the navigation in the next frame
            }
        }
